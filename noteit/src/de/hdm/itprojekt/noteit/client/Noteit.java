...
public class Noteit implements EntryPoint {
	...
	private static Label loginLabel = new Label("Melde dich mit deinem Google-Konto an um Noteit nutzen zu kÃ¶nnen.");
	...
	public void onModuleLoad() {
		...
		/**
		 * Login Status mit Login service Ã¼berprÃ¼fen. Client-side proxy
		 * erstellen.
		 */
		...
		// ClickHandler fÃ¼r LogOut Button
