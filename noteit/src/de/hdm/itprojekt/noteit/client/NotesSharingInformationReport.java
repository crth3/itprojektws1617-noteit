...
/**
 * Diese "NotesSharingInformationReport" Klasse stellt die View zur Verfügung,
 * um Freigaben von Notizen eines Nutzer anzuzeigen.
 * 
...
public class NotesSharingInformationReport extends VerticalPanel {
	...
	/**
	 * Bei einer neuen Instanz von NotesSharingInformationReport wird eine
	 * SuggestBox (Nutzerauswahl) erstellt. Es können weitere Suchparameter wie
	 * z.B. nach Berechtigung eingegeben werden
	 */
		...
		btnGenerate.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				if (user != null) {
					...
					reportService.createReportNotesSharingInformation(user, permission,
							new AsyncCallback<NotesSharingInformation>() {
