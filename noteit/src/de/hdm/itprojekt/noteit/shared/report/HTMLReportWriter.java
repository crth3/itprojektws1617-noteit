...
public class HTMLReportWriter extends ReportWriter {
  ...
  public String paragraph2HTML(Paragraph p) {
    if (p instanceof ParagraphComposite) {
      return this.paragraph2HTML((ParagraphComposite) p);
    }
    else {
      return this.paragraph2HTML((ParagraphSimple) p);
    }
  }

  /**
   * Umwandeln eines <code>ParagraphComposite</code>-Objekts in HTML.
   * 
   * @param p der ParagraphComposite
   * @return HTML-Text
   */
  public String paragraph2HTML(ParagraphComposite p) {
  ...
  /**
   * Umwandeln eines <code>ParagraphSimple</code>-Objekts in HTML.
   * 
   * @param p der ParagraphSimple
   * @return HTML-Text
   */
  public String paragraph2HTML(ParagraphSimple p) {
   ...
   */
  public void process(NotesGeneralInformation r) {
   ...
   * @param r der zu prozessierende Report
   */
  public void process(NotesSharingInformation r) {
    // Zunächst löschen wir das Ergebnis vorhergehender Prozessierungen.
    this.resetReportText();
...
public void process(ReportSimple r) {
	// Zunächst löschen wir das Ergebnis vorhergehender Prozessierungen.
    this.resetReportText();
